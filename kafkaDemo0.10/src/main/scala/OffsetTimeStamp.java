...
//
//        return String.format("hit= %s, topicPartition=%s, offset=%s ,timestamp=%s ,date=%s ,payload=%s", hit, topicPartition, offset, timestamp, new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new java.util.Date(timestamp)),payload);
//    }
//}
